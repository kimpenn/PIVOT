...
if(input$hmap_package == 'gplots'){ # heatmap.2
    ...
    hmap<-heatmaply::heatmaply(as.matrix(hmList()$df),colors=get_heatmap_color(input$hmap_hmcolor), scale="none", Rowv = hm_ft_dend(), Colv = hm_sp_dend(), dendrogram=dend1,revC=T)
}
